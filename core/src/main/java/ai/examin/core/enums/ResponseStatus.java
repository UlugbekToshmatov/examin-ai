...
public enum ResponseStatus {
    ...
    TOKEN_NOT_FOUND(4, HttpStatus.BAD_REQUEST, "Token not found"),
    INVALID_TOKEN(5, HttpStatus.BAD_REQUEST, "Invalid token"),
    TOKEN_EXPIRED(6, HttpStatus.BAD_REQUEST, "Token expired"),
    TOKEN_MISMATCH_EXCEPTION(7, HttpStatus.BAD_REQUEST, "This token does not belong to you! Use your own token."),
    TOKEN_PROCESSING_ERROR(8, HttpStatus.INTERNAL_SERVER_ERROR, "Token processing error"),
    TOKEN_MUST_START_WITH_BEARER(9, HttpStatus.BAD_REQUEST, "Token must start with 'Bearer '"),
