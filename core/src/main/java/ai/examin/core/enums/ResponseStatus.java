...
public enum ResponseStatus {
    ...
    EMAIL_CONFIRMATION_REQUIRED(105, HttpStatus.BAD_REQUEST, "Please, confirm your email address registered in the system"),
    INCORRECT_PASSWORD(106, HttpStatus.BAD_REQUEST, "Incorrect password"),
    ERROR_REGISTERING_USER(107, HttpStatus.INTERNAL_SERVER_ERROR, "Error while registering user"),
